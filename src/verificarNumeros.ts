...
console.log(
  "Caso 1 (numero_destino = whatsapp_cliente):",
  getNumeroClienteFinal(caso1),
);
...
console.log(
  "Caso 2 (numero_remetente = whatsapp_cliente):",
  getNumeroClienteFinal(caso2),
);
