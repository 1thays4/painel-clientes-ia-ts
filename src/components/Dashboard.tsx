...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  const [estatisticasCliente, setEstatisticasCliente] =
    useState<EstatisticasCliente>({
      mensagensUsadas: 0,
  ...
  const carregarEstatisticasCliente = async (clienteId: string | number) => {
    ...
    const ultimaAtividade =
      ultimaAtividadeData && ultimaAtividadeData.length > 0
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasGerais.totalMensagens}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasGerais.mensagensHoje}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasGerais.mensagensSemana}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasGerais.mensagensMes}
                  </Typography>
                </Grid>
              </Grid>
            </CardContent>
            ...
            <CardContent sx={{ pt: 3, pb: 3 }}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasGerais.clientesTotal}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasGerais.clientesAtivos}
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography
            ...
            <CardContent sx={{ pt: 3, pb: 3 }}>
              ...
              <Grid container spacing={2} sx={{ mt: 1 }}>
                <Grid item xs={6}>
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasCliente.mensagensHoje}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
                  ...
                  <Typography variant="h4" fontWeight="700">
                    {estatisticasCliente.mensagensSemana}
                  </Typography>
                </Grid>
              </Grid>
            </CardContent>
            ...
            <CardContent sx={{ pt: 3, pb: 3 }}>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <Typography variant="h5" fontWeight="600">
                  {formatarData(estatisticasCliente.ultimaAtividade)}
                </Typography>
              </Box>
              <Divider sx={{ my: 2 }} />
              <Box sx={{ mt: 3 }}>
                ...
                <Typography variant="h5" fontWeight="600">
                  {Math.round(estatisticasCliente.mensagensSemana / 7)}{" "}
                  mensagens/dia
                </Typography>
              </Box>
            </CardContent>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <Typography
              ...
              color={
                ...
                cliente?.mensagens_usadas >= cliente?.mensagens_limite * 0.8
                  ? "warning.main"
                  : "inherit"
              }
            >
  ...
  return (
    <Box>
      ...
      {!isAdmin &&
        clienteId &&
        renderDetalhesDoPlanoPara(
          cliente || {
            plano:
              estatisticasCliente?.mensagensLimite === 1000
                ? "Básico"
                : estatisticasCliente?.mensagensLimite === 3000
                  ? "Intermediário"
                  : "Avançado",
