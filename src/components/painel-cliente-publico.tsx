          ...
          {cliente && (
            <>
              ...
              <Typography variant="body1" sx={{ mb: 3 }}>
                Bem-vindo ao seu painel de cliente. Aqui você pode ver os
              ...
              {cliente.mensagens_usadas !== undefined &&
                cliente.mensagens_limite !== undefined && (
                  <Paper variant="outlined" sx={{ p: 2, mb: 3 }}>
                    <Typography
                      variant="subtitle1"
                      sx={{ fontWeight: "medium", mb: 1 }}
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      Você usou {cliente.mensagens_usadas} de{" "}
                      {cliente.mensagens_limite} interações com IA no WhatsApp
                      este mês.
                    </Typography>
                    <LinearProgress
                      variant="determinate"
                    ...
                    {cliente.mensagens_usadas >= cliente.mensagens_limite ? (
                      ...
                      >
                        Você atingiu o limite de interações deste mês. Considere
                        fazer um upgrade de plano.
                      </Typography>
                    ) : (
                      <Typography
                        variant="caption"
                      ...
                      >
                        Restam{" "}
                        {cliente.mensagens_limite - cliente.mensagens_usadas}{" "}
                        interações com IA neste mês.
                      </Typography>
                    )}
                  </Paper>
                )}
