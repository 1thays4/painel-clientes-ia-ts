...
export default function DebugMensagens({
  mensagens,
  ...
  return (
    <Paper sx={{ p: 2, mb: 2, bgcolor: theme.palette.background.default }}>
      ...
      <Typography variant="body2">
        Cliente Final Selecionado: {clienteFinalSelecionado}
      </Typography>
      <Typography variant="body2">
      ...
      {mensagensParaMostrar.map((msg, index) => (
        <Box
          key={index}
          sx={{ mt: 1, p: 1, bgcolor: theme.palette.divider, borderRadius: 1 }}
        >
          <Typography variant="caption" component="div">
            ID: {msg.id}, Cliente Final ID: {msg.cliente_final_id} (tipo:{" "}
            {typeof msg.cliente_final_id})
          </Typography>
          <Typography variant="caption" component="div">
